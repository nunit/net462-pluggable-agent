...
namespace NUnit.Engine.Agents
{
    ...
    public class Net462AgentLauncher : LocalProcessAgentLauncher
    {
        ...
        protected override string AgentPath => Path.Combine(LAUNCHER_DIR, $"agent/nunit-agent-net462.exe");
        protected override string X86AgentPath => Path.Combine(LAUNCHER_DIR, $"agent/nunit-agent-net462-x86.exe");
    }
}
#endif
